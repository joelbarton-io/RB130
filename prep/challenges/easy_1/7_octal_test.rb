...
class OctalTest < Minitest::Test
  ...
  def test_6789_is_seen_as_invalid_and_returns_0 # this
    # skip
    assert_equal 0, Octal.new('6789').to_decimal
  end

  def test_abc1z_is_seen_as_invalid_and_returns_0  # this
    # skip
  ...
  def test_234abc_is_seen_as_invalid_and_returns_0  # this
    # skip
